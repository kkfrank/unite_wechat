...
Page({
  ...
  data: {
    ...
    list: [{
      url: 'https://10.url.cn/qqcourse_logo_ng/ajNVdqHZLLBGOS47DsaYA9MlKW9pZRYTy92Ric1ZowUHNPDzlyyhNEyrmWBcqjyAicu00ALqsD2FM/356?tp=webp',
      name: '悟空',
      course: 'C#',
      ...
      description: '专业电商从业讲师数据化定制辅导淘宝天猫店铺爆款打造/标题制作/标题优化/手淘首页流量获取/手淘自然搜索流量获取/直通车付费推广/提升直通车质量分/淘宝客推广/生意参谋解析/关键词权重解析/钻展推广/淘宝社区/淘宝直播/活动报名/内容营销/双十一活动淘宝货源/店铺创业网络远程名师在线学习'
        ...
        url: 'https://10.url.cn/qqcourse_logo_ng/ajNVdqHZLLBdeyKs05tU5oWcyNyP8vLvmHupN0DeGFAkdNAicnYxU4cfIjQ28w8cAxEoDoPU9ezo/356?tp=webp',
      name: '悟空',
      course: 'Java',
      startTime: '2019-09-02',
      endTime: '2019-10-02',
